...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=627028498ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=zmija&table=korisnici">`zmija`.`korisnici`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kolokvijum&table=vrsta_pomoci">`kolokvijum`.`vrsta_pomoci`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kolokvijum&table=zahtev">`kolokvijum`.`zahtev`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rentacar&table=rezervacije">`rentacar`.`rezervacije`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rentacar&table=auto">`rentacar`.`auto`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rentacar&table=users">`rentacar`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="59352a7c5f5c5d793f42466974674755">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="zmija" targettable="korisnici">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `zmija`.`korisnici` ( `id` INT NOT NULL AUTO_INCREMENT ,  `username` VARCHAR(20) NOT NULL ,  `password` VARCHAR(20) NOT NULL ,  `highscore` INT NOT NULL DEFAULT &#039;0&#039; ,    PRIMARY KEY  (`id`),    UNIQUE  (`username`)) ENGINE = InnoDB;</span>
                        </div>
